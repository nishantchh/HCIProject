...
Public Class Vehicle
    ...
    Private Sub Vehicle_load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dt.Columns.Add("Milege", GetType(Integer))
        dt.Columns.Add("Engin Capacity", GetType(Integer))
        dt.Columns.Add("Colour", GetType(String))
        dt.Columns.Add("Making Date", GetType(Date))
        dt.Columns.Add("Fuel Type", GetType(String))
    ...
    Private Sub btninsert_Click(sender As Object, e As EventArgs) Handles btninsert.Click
        If Textmodel.Text <> "" And Textbrand.Text <> "" Then
            dt.Rows.Add(Textmodel.Text, Textbrand.Text, Textmilege.Text, Textengin.Text, ComboBox1.SelectedItem, DateTimePicker2.Value.ToString("dd/MM/yyyy"), ComboBox2.SelectedItem)
    ...
    Private Sub btnupdate_Click(sender As Object, e As EventArgs) Handles btnupdate.Click
        ...
        newdata.Cells(3).Value = Textengin.Text
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        Textengin.Text = selectedRow.Cells(3).Value.ToString()
